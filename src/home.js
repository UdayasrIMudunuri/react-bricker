...
import { Footer, MetaTags } from './components/CommonComponents/CommonComponents';
import SliderSection from './components/landing/SliderSection';

/** This is the first page that you will see. this is also a functional component. 
 */
function Home() {
  let keywords = {
		mainKeyword: "BRICKER",
		subKeyword: "RESPONSIVE WEBSITE",
		description: "GUIDED BY PURAN SIR...."
	}
  return (
    <div style={{ backgroundColor: '#002633' }}>
      ...
      <header className="grid">
        <nav className="s-12 grid" style={{ backgroundColor: '#002633' }}>
          ...
          <div>
          <SliderSection keywords={keywords} style={{ color: 'white', fontWeight: 'bold', fontSize: '1.2em' }} />
        </div>
        </nav>
      </header>
      {/* MAIN */}
